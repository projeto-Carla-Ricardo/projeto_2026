...
INDICADORES = [
    ...
    (1,1,'O.E.2','Existe uma visão estratégica para a utilização de IA na organização?','Sem visão definida para IA','Estratégia de IA documentada e comunicada','IA como pilar estratégico com roadmap ativo e revisão periódica',1.0,2),
    ...
    (2,2,'H.C.2','Como é a partilha de conhecimento entre equipas?','Silos de informação entre departamentos','Práticas de partilha de conhecimento existem','Cultura aberta com comunidades de prática ativas e suportadas',1.0,5),
