...
function updateNavbar() {
    ...
    if (api.isAuthenticated()) {
        ...
        const dashLink = isAdmin ? '/pages/admin_dashboard.html' : '/pages/dashboard.html';
        const dashLabel = isAdmin ? '📊 Dashboard Admin' : 'Dashboard';
        navLinks.innerHTML = `
            <a href="${dashLink}" class="nav-link" ${isAdmin ? 'style="color:var(--ailo-cognitiva);font-weight:600;"' : ''}>${dashLabel}</a>
            ${isAdmin ? '<a href="/pages/dashboard.html" class="nav-link" style="font-size:13px;">👁️ Ver como Utilizador</a>' : ''}
            <a href="/pages/organizacoes.html" class="nav-link">Organizações</a>
            <a href="/pages/comparacao.html" class="nav-link">Comparação</a>
            <a href="/pages/benchmarking.html" class="nav-link">Benchmarking</a>
            <a href="/pages/configuracoes.html" class="nav-link">⚙️</a>
